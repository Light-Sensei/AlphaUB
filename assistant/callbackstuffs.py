...
try:
    from AlphaOP.fns.gDrive import GDriveManager
except ImportError:
    GDriveManager = None
...
from AlphaOP.fns.helper import fast_download, progress
from AlphaOP.fns.tools import Carbon, async_searcher, get_paste, telegraph_client
from AlphaOP.startup.loader import Loader
...
_buttons = {
    "otvars": {
        "text": "Other Variables to set for @Cultured_Heaven:",
        "buttons": [
            [
...
async def update(eve):
    ...
    if heroku_api:
        ...
        execl(sys.executable, sys.executable, "-m", "AlphaOP")
