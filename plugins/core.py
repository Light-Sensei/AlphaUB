...
from AlphaOP.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, ALPHA_cmd, un_plug


@ALPHA_cmd(pattern="install", fullsudo=True)
...
@ALPHA_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
